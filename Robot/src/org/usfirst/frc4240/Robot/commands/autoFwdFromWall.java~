...
package org.usfirst.frc4240.Robot.commands;
 ...
 *
 */
public class autoFwdFromWall extends Command {
    ...
    protected void execute() {
    	...
    	RobotMap.driveTrainRobotDrive.arcadeDrive(-1.0,-turnValue);	
    }
